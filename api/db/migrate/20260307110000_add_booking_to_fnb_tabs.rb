class AddBookingToFnbTabs < ActiveRecord::Migration[8.0]
  def change
    safety_assured { add_reference :fnb_tabs, :booking, null: true, foreign_key: true }
    ...
    safety_assured { add_index :fnb_tabs, [:booking_id, :turn_order], name: 'index_fnb_tabs_on_booking_and_turn_order' }
  end
end
